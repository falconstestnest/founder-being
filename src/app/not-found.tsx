...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#0B0B0B] px-6 text-center text-[#F8F8F8]">
      ...
      <p className="mt-4 max-w-md text-sm leading-relaxed text-[#F8F8F8]/65">
